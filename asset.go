...
func init() {
	flag.StringVar(&varName, "var", "mybuffer", "the name of the variable containig the []bytes. Can be local or global.")
	flag.StringVar(&varName, "v", "mybuffer", "the name of the variable containig the []bytes. Can be local or global.")
